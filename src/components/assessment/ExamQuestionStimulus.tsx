...
export const QuestionPromptBlock: React.FC<{
...
export function stripEmbeddedOptionLetterPrefix(option: string): string {
 ...
 */
export function shouldSuppressInstructionAsDuplicateRule(q: ExamQuestion): boolean {
...
export type VisualChoiceMatrix = string[][];
...
export function visualChoicesFromQuestion(question: ExamQuestion): VisualChoiceMatrix[] | null {
  ...
  return (
    <Box
      sx={{
        ...
        ...(unboundedHeight
          ? { overflow: 'visible' }
          : { maxHeight: gridMatrix ? 520 : 320, overflow: 'auto' }),
      }}
    >
      {gridMatrix ? (
        <StimulusGridMatrixView matrix={gridMatrix} border={border} renderMath={renderMath} theme={theme} />
