...
import {
  Box, Card, CardContent, Typography, Button, Chip, Snackbar, Alert,
} from '@mui/material';
import {
...
const SchoolPreviewReportsPage: React.FC = () => {
  const [toast, setToast] = useState<string | null>(null);

  const handleDownload = (title: string) => {
    setToast(`Preview mode: "${title}" would download as a document after your school is onboarded.`);
  };
    ...
    <Box sx={{ maxWidth: 900, mx: 'auto', pb: 6 }}>
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body2" sx={{ color: '#94a3b8' }}>
          Downloadable performance reports for board meetings and parent communications (simulated in this preview).
        </Typography>
      </Box>
...
export default SchoolPreviewReportsPage;
