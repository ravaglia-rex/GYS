  ...
  const levels = [
    {
      ...
      features: [
        { text: 'Exam 1: Symbolic Reasoning', included: true },
        ...
        { text: 'Exams 2–3 (Verbal, Mathematical) – Level 2', included: false },
        { text: 'Personality & English exams – Level 3', included: false },
      ],
    ...
    },
    {
      ...
      accent: 'bg-emerald-500',
      features: [
        { text: '3 Reasoning Exams (Symbolic, Verbal, Mathematical)', included: true },
    ...
    },
    {
      ...
      features: [
        { text: 'Everything in Level 2 (Exams 1–3)', included: true },
        { text: 'Exam 4: Personality Profile (8 dimensions)', included: true },
        { text: 'Exam 5: English Proficiency (listening + speaking)', included: true },
        { text: 'Exam 7: Comprehensive Personality (~30 dimensions)', included: true },
                ...
                <table className="min-w-full text-left text-[11px] sm:text-xs">
                  ...
                  <tbody>
                    {[
                      ...
                      ['Exam 2: Verbal Reasoning', '–', '✓', '✓'],
                      ['Exam 3: Mathematical Reasoning', '–', '✓', '✓'],
                      ['Exam 4: Personality Profile', '–', '–', '✓'],
                      ['Exam 5: English Proficiency', '–', '–', '✓'],
                      ['Exam 7: Comprehensive Personality', '–', '–', '✓'],
                      ['Basic Report + Tier', '✓', '✓', '✓'],
