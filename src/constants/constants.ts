...
export const GET_OFFICIAL_EXAM_OPS='/getOfficialExamOps';
export const GET_STUDENT_ASSESSMENTS='/getStudentAssessments';
export const INITIALIZE_EXAM='/initializeExam';
export const PREFETCH_NEXT_QUESTION='/prefetchNextQuestion';
export const RECORD_ANSWER='/recordAnswer';
export const RECORD_ANSWERS_BATCH='/recordAnswersBatch';
...
// School-scoped live uses OFFICIAL_SCHOOL_LIVE_ASSESSMENTS (not a public launch).
